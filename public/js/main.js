...
var Main = function() {
    ...
    var setColorScheme = function() {
        $('.icons-color a').on('click', function() {
            ...
            $('#skin_color').attr("href", "http://pj.suifangyi.com/css/themes/theme-" + $(this).attr('id') + ".css");
            switch ($(this).attr('id')) {
                case "style3":
                    $(".navbar-brand img").attr("src", "http://pj.suifangyi.com/images/newlogo_dark.png");
                    break;
                default:
                    $(".navbar-brand img").attr("src", "http://pj.suifangyi.com/images/newlogo.png");
                    break;
            };
        });
    };
    ...
    var runSaveSetting = function() {
        $('.save_style').on('click', function() {
            ...
            $.cookie("espresso-setting", JSON.stringify(espressoSetting),{path:'/'});
