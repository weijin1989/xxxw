...
//        dd($table);
        return view('news.draft.statistics',compact('list','c','media_id','url','users','medias','medias1','starttime','endtime','search','order_by','order_by_select','data'));
    }
    //上稿统计 列表
...
//        dd($table);
        return view('news.draft.statistics1',compact('list','c','media_id','url','users','medias','medias1','starttime','endtime','search','order_by','order_by_select','data'));
    }
    //获奖录入
