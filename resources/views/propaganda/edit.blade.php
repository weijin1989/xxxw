            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ base64_decode($url) }}">典型宣传报告列表</a></li>
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    {!! Form::model($info,array('class'=>'form-horizontal','route' => ['propaganda.editSave',$info->id],'method'=>'POST','id'=>'form')) !!}
                                    {{--<form id="form" method="post" class="form-horizontal" action="/news/draft/addSave">--}}
                                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            ...
                                            <div class="col-sm-5 status">
                                                <select id="types" class="form-control types"  name="types" >
                                                    ...
                                                    @foreach(config('configure.pro_types') as $k=>$v)
                                                        <option class="option" value="{{$k}}" @if($info->types==$k) selected @endif>{{$v}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-5 status">
                                                <select id="category" class="form-control category"  name="category" >
                                                    ...
                                                    @foreach(config('configure.pro_category') as $k=>$v)
                                                        <option class="option" value="{{$k}}" @if($info->category==$k) selected @endif>{{$v}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                {!! Form::text('name',null,array('id' => 'name','class' => 'form-control required name ' ,'data-toggle'=>'dropdown','autocomplete'=>"off")) !!}
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-5 status">
                                                <select id="cur_type" class="form-control cur_type"  name="cur_type" >
                                                    ...
                                                    @foreach(config('configure.pro_cur_type') as $k=>$v)
                                                        <option class="option" value="{{$k}}" @if($info->cur_type==$k) selected @endif>{{$v}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-5 status">
                                                <select id="p_id" class="form-control p_id"  name="p_id" >
                                                    ...
                                                    @foreach($p_area as $k=>$v)
                                                        <option class="option" value="{{$k}}" @if($area_info->pid==$k) selected @endif>{{$v}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-5 status">
...
//             laydate(start);
            ...
            function getByMedia(media_type) {
                $.ajax({
                    ...
                    dataType:'json',
                    data:{p_id:media_type,_token:post_token},
