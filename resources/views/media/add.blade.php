                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    <form id="form" method="post" class="form-horizontal" action="/media/addSave">
                                        ...
                                        {{--<div class="form-group">--}}
                                            ...
                                            {{--</label>--}}
                                            {{--<div class="col-sm-10">--}}
                                                {{--{!! Form::select('media_type',config('configure.media_type'),'',array('id' => 'media_type','class' => 'form-control required tel ')) !!}--}}
                                            {{--</div>--}}
                                        {{--</div>--}}
                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::select('media_level',config('configure.media_level'),'',array('id' => 'media_level','class' => 'form-control required tel ')) !!}
                                            </div>
                                        </div>
                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 status">
                                                {!! Form::text('media_name',null,array('placeholder' => '请输入媒体名称','id' => 'media_name','class' => 'form-control required media_name ',"maxlength"=>"80")) !!}
                                            </div>
                                        </div>
                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 status">
                                                {!! Form::text('media_info',null,array('placeholder' => '请输入媒体描述','id' => 'media_info','class' => 'form-control media_info ',"maxlength"=>"80")) !!}
                                            </div>
                                        </div>
                                        <div class="hr-line-dashed"></div>
...
@section('jscontent')
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            //         }
            //
            //         console.log(ajax_check_mediaName());
            //         if(!ajax_check_mediaName()){
            //             pop('提示','媒体名称已存在',3);
            //             return false;
            //         }
            //         return ;
            ...
            function ajax_check_mediaName() {
                ...
                $.ajax({
                    ...
                    dataType:'json',
                    data:{media_type:media_type,media_level:media_level,media_name:media_name,_token:post_token},
            ...
            //                     _token:function(){return post_token;}}, "/media/ajax_check_mediaName")   //AJAX验重
            //         }
            //     },
            //     messages: {
            //         media_name: {
