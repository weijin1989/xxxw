                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    {!! Form::model($info,array('class'=>'form-horizontal','route' => ['review.draft.editSave',$info->id],'method'=>'POST','id'=>'form')) !!}
                                    {{--<form id="form" method="post" class="form-horizontal" action="/news/draft/addSave">--}}
                                            ...
                                            {{--<div class="col-sm-10 status">--}}
                                                {{--<select id="media_id" class="form-control chosen-select media_id required"  name="media_id" tabindex="2">--}}
                                                    {{--@foreach($medias as $k=>$v)--}}
                                                        {{--<option class="option" value="{{$v->id}}" @if($info->media_id==$v->id) selected @endif>{{config('configure.media_type')[$v->media_type]}}--{{config('configure.media_level')[$v->media_level]}}--{{$v->media_name}}</option>--}}
                                                    {{--@endforeach--}}
                                                {{--</select>--}}
                                            {{--</div>--}}
                                            <div class="col-sm-5 status">
                                                <select id="media_type" class="form-control media_type"  name="media_type" >
                                                    ...
                                                    @foreach(config('configure.media_level') as $k=>$v)
                                                        <option class="option" @if($media_type==$k) selected @endif value="{{$k}}">{{$v}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-5 status">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::textarea('content',null,array('placeholder' => '内容','id' => 'content','class' => '','style' => 'min-height:200px')) !!}
