            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ base64_decode($url) }}">评阅确认列表</a></li>
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    {!! Form::model($info,array('class'=>'form-horizontal','route' => ['review.draft.editConfirmSave',$info->id],'method'=>'POST','id'=>'form')) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                {!! Form::text('created_at',null,array('placeholder' => '发布时间','class' => 'form-control ',"maxlength"=>"20",'disabled'=>'disabled')) !!}
                                            </div>
                                            <label class="col-sm-2 control-label">
                                                字数
                                            </label>
...
//                ],
            ...
            $("#form").validate({
                ...
                rules: {
                    title: {
                        required: true,
                        remote: genAjaxRemote("{{$info->id}}", "/review/draft/ajax_check_title", post_token)   //AJAX验重
                    }
                },
                messages: {
                    title: {
