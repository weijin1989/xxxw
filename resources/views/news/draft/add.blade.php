            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ url('/news/draft') }}">记者上稿列表</a></li>
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                        {!! Form::open(array('class'=>'form-horizontal','route' => 'news.draft.addSave','method'=>'POST','id'=>'form')) !!}
...
{{--                                                {!! Form::text('title','',array('id' => 'title','class' => 'form-control required title ','autocomplete'=>"off")) !!}--}}
                                                {!! Form::text('title','',array('id' => 'title','class' => 'form-control required title ' ,'data-toggle'=>'dropdown','autocomplete'=>"off")) !!}
