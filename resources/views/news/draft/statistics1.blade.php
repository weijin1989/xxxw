                        ...
                        <div class="panel-body">
                            <div id="myTabContent" class="tab-content">
                                ...
                                <div class="tab-pane fade in active" id="home">
                                    ...
                                    <div id="toolbar">
                                        <form id="from1" class="form-inline" method="get" action="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="media_level" id="media_level" class="form-control">
                                                    <option value="">全部</option>
                                                    @foreach(config('configure.media_level') as $k=>$v)
                                                    <option value="{{$k}}" @if($media_level==$k) selected @endif>{{$v}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                &nbsp;<label for="wxnameID">媒体新旧：</label>
                                                <select name="is_past" id="is_past" class="form-control">
                                                    <option value="">全部</option>
                                                    <option value="0" @if(isset($is_past)&&$is_past==0) selected @endif>新媒体</option>
                                                    <option value="1" @if($is_past==1) selected @endif>旧媒体</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    @if(count($list)>0)
                                        {!!
                                        $list->appends(['starttime' => $starttime,'cat_page' => $cat_page,'media_level' => $media_level,'endtime' => $endtime,'media_id' => $media_id,'search' => $search,'order_by' => $order_by,'order_by_select' => $order_by_select,])->render()
                                        !!}
                                    @endif
                                </div>
                            </div>
...
@section('jscontent')
    ...
    <script>
        ...
        $("#export").click(function () {
            ...
            var is_past = $('#is_past').val();
            window.location.href = "/news/draft/statistics/statistics1?search=" + search + '&export=1&endtime=' + endtime + '&starttime=' + starttime +  '&cat_page=' + cat_page +  '&is_past=' + is_past+  '&media_level=' + media_level;
